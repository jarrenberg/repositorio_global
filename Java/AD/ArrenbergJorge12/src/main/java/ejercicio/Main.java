	...
	public static void menu() {
		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			do {
				...
				int accion = UtilidadesSQL.devolverEntero(sc, "ACCION:");
				...
				case 1:
					...
					String destino = UtilidadesSQL.devolverString(sc, "Introduzca el destino: ");
				...
				case 2:
					...
					destino = UtilidadesSQL.devolverString(sc, "Introduzca el destino: ");
					int codigoCliente = UtilidadesSQL.devolverEntero(sc, "Introduzca el codigo del cliente: ");
					int plazasCliente = UtilidadesSQL.devolverEntero(sc,
				...
				case 3:
					...
					codigoCliente = UtilidadesSQL.devolverEntero(sc, "Introduzca el codigo del cliente: ");
					int codigoReserva = UtilidadesSQL.devolverEntero(sc, "Introduzca el codigo de la reserva: ");
