...
import io.swagger.client.model.KeyLineDefinition;
import io.swagger.client.model.PriceLadderDefinition;
 ...
 * MarketDefinition
 */
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2025-09-27T00:34:17.961+02:00")
public class MarketDefinition   {
  ...
  @SerializedName("betDelayModels")
  private List<String> betDelayModels = new ArrayList<String>();
  ...
  **/
   ...
   * @return lineMaxUnit
  **/
  @ApiModelProperty(example = "null", value = "For Handicap and Line markets, the maximum value for the outcome, in market units for this market (eg 100 runs).")
  ...
  **/
   ...
   * @return lineMinUnit
  **/
  @ApiModelProperty(example = "null", value = "For Handicap and Line markets, the minimum value for the outcome, in market units for this market (eg 0 runs).")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Definition of the price ladder type and any related data.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Definition of a markets key line selection (for valid markets), comprising the selectionId and handicap of the team it is applied to.")
  ...
  **/
  ...
  public MarketDefinition suspendReason(String suspendReason) {
  ...
  **/
  ...
  public MarketDefinition betDelayModels(List<String> betDelayModels) {
    this.betDelayModels = betDelayModels;
    return this;
  }

  public MarketDefinition addBetDelayModelsItem(String betDelayModelsItem) {
    this.betDelayModels.add(betDelayModelsItem);
    return this;
  }

   /**
   * Get betDelayModels
   * @return betDelayModels
  **/
  @ApiModelProperty(example = "null", value = "")
  public List<String> getBetDelayModels() {
    return betDelayModels;
  }

  public void setBetDelayModels(List<String> betDelayModels) {
    this.betDelayModels = betDelayModels;
  }
  ...
  public String toString() {
    ...
    sb.append("    betDelayModels: ").append(toIndentedString(betDelayModels)).append("\n");
    sb.append("}");
    return sb.toString();
  }
