...
public class RunnerDefinition   {
  ...
  **/
  ...
  public RunnerDefinition name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", value = "The name of the runner")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.sortPriority, runnerDefinition.sortPriority) &&
        ...
        Objects.equals(this.name, runnerDefinition.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(sortPriority, removalDate, name, id, hc, adjustmentFactor, bsp, status);
  }
