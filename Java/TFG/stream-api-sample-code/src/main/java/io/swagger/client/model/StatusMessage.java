...
public class StatusMessage extends ResponseMessage  {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The number of connections available for this account at this moment in time. Present on responses to Authentication messages only.")
