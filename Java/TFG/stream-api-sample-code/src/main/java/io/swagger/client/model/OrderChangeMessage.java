...
public class OrderChangeMessage extends ResponseMessage  {
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(example = "null", value = "Stream status: set to null if the exchange stream data is up to date and 503 if the downstream services are experiencing latencies")
