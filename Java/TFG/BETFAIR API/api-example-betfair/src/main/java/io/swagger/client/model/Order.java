...
public class Order   {
   ...
   * @return side
  **/
  @ApiModelProperty(example = "null", value = "Side - the side of the order. For Line markets a 'B' bet refers to a SELL line and an 'L' bet refers to a BUY line.")
  ...
  **/
   ...
   * @return lsrc
  **/
  @ApiModelProperty(example = "null", value = "Lapse Status Reason Code - the reason that some or all of this order has been lapsed (null if no portion of the order is lapsed")
   ...
   * @return p
  **/
  @ApiModelProperty(example = "null", value = "Price - the original placed price of the order. Line markets operate at even-money odds of 2.0. However, price for these markets refers to the line positions available as defined by the markets min-max range and interval steps")
  public Double getP() {
    return p;
  }
  ...
  **/
   ...
   * @return cd
  **/
  @ApiModelProperty(example = "null", value = "Cancelled Date - the date the order was cancelled (null if the order is not cancelled)")
  public Long getCd() {
    return cd;
  }
   ...
   * @return ld
  **/
  @ApiModelProperty(example = "null", value = "Lapsed Date - the date the order was lapsed (null if the order is not lapsed)")
  public Long getLd() {
    return ld;
  }
  ...
  **/
   ...
   * @return avp
  **/
  @ApiModelProperty(example = "null", value = "Average Price Matched - the average price the order was matched at (null if the order is not matched). This value is not meaningful for activity on Line markets and is not guaranteed to be returned or maintained for these markets.")
