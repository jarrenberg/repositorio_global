...
class Auth extends Conexion  {
    ...
    private function getOpcionGrupoAccion() {
        try {
            $sql = $this->conexion->prepare("SELECT opcion, grupo, accion FROM sgi_roles inner join sgi_vista_rol_menu USING(id_opcion_menu) WHERE sgi_roles.id_rol = :id_rol GROUP by sgi_roles.id_rol");
