...
//					echo '<br />';
		...
		foreach ($this->_definedname as $definedName) {
			if ($definedName['isBuiltInName']) {
				...
				case pack('C', 0x06):
					// print area
					//	in general, formula looks like this: Foo!$C$7:$J$66,Bar!$A$2:$IV$2
				...
				case pack('C', 0x07):
					...
					// 1. repeating rows
					//		formula looks like this: Sheet!$A$2:$IV$2
					//		rows 1-2 repeat
					// 2. repeating columns
					//		formula looks like this: Sheet!$A$2:$B$65536
					//		columns A-B repeat
					// 3. both repeating rows and repeating columns
					//		formula looks like this: Sheet!$A$2:$B$65536,Sheet!$A$2:$IV$2
